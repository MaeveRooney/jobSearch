			...
			<div class="span3">
			  <div class="well sidebar-nav">
				...
				<div style="float:right" class="span9">
					<form method="POST" action="handleAd.php">
						<input type="hidden" name="tag" value="activateAd">
						<input type="hidden" name="position_id" value="<?php echo $position_id ?>">
						<br/>
						<button class="btn btn-large btn-primary" type="submit">Activate Ad</button>
					</form>
    				...
    				if (count($positions) ==0) {
						...
						foreach ($positions as $position){
							...
							echo "<div style='float:right; border: 1px solid; padding:10px; margin:10px' class='span9'><div class='span6'>";
								...
								echo "<p><strong>Date of Ad Deactivation:</strong></p><p> " . $position['dateDeactivated'] . "</p>";
